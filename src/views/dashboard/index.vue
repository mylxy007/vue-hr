              ...
              <ul class="noticeList">
                <li>
                  <div class="item">
                    ...
                    <div>
                      <p><span class="col">啊咧咧</span> 发布了 xxxxxxx</p>
                      <p>2022-10-1 15:21:38</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="item">
                    <img src="@/assets/common/img.jpeg" alt="" />
                    <div>
                      <p><span class="col">张三</span> 发布了 xxxxxxx</p>
                      <p>2022-10-1 15:21:38</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="item">
                    <img src="@/assets/common/img.jpeg" alt="" />
                    <div>
                      <p><span class="col">李四</span> 发布了 xxxxxxx</p>
                      <p>2022-10-1 15:21:38</p>
                    </div>
                  </div>
                </li>
